#ifndef STDEventSaver_HH
#define STDEventSaver_HH
#include <time.h>
...
class STDEventSaver : public LKTask
{ 
    enum kPID{
        kNe20 = 0,
        kC12 = 1,
    ...
    private:
        ...
        double outSiESum[8][5]; // [siDetNum][ne,c,alpha,B,total]


    ClassDef(STDEventSaver, 1)
};
